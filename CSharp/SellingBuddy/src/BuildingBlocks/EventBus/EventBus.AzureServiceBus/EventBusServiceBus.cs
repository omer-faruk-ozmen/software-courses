...
namespace EventBus.AzureServiceBus
{
    public class EventBusServiceBus : BaseEventBus
    {
        ...
        public override void Subscribe<T, TH>()
        {
            ...
            {
                var subscriptionClient = CreaeteSubscriptionClientIfNotExists(eventName);
        ...
        private ISubscriptionClient CreaeteSubscriptionClientIfNotExists(string eventName)
        {
