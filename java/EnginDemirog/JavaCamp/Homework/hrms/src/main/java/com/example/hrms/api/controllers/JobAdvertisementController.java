...
public class JobAdvertisementController {
	...
	public DataResult<List<JobAdvertisement>> getByIsActiveAndPostingDate(Date creationDate,Sort sort){
		
		
		
		return this.JobAdvertisementService.getByIsActiveAndCreationDate(creationDate, sort);
	}
	...
	public DataResult<List<JobAdvertisement>> getByIsActiveAndEmployerId(int employerId){
		...
		return this.JobAdvertisementService.getByIsActiveAndEmployersId(employerId);
	}
