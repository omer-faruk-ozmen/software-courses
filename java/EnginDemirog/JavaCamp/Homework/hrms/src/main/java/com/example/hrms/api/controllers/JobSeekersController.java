...
public class JobSeekersController {
	...
	public DataResult<List<JobSeekers>> findByIdentityNumberIs(@RequestBody String identityNumber) {
		return this.jobSeekersService.findByIdentityNumberIs(identityNumber.trim());
	}
